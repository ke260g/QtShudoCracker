/* the maze_solve's core algorithms */

#include"shudu.h"

gboolean is_pos_val(const int y, const int x, int value) {
#if VERBOSE
    display_maze();
...
gboolean sol_maze(const int y, const int x) {
    if(src_maze[y][x] != 0){
